...
import { Save, Tag, Sparkles, Mic, Square } from 'lucide-react-native';
...
export default function CreateReport2Screen() {
...
Sé directo y conciso.`;
      ...
      console.log('📝 Generando informe con nuevo endpoint...');
      ...
      console.log('✅ Contenido generado exitosamente con endpoint alternativo');
      ...
      if (Platform.OS === 'web') {
        ...
        Alert.alert('Error', `Error al generar el informe: ${errorMessage}`);
      }
    } finally {
              ...
              <View style={styles.aiSection}>
                ...
                >
                  ...
                  <Text style={[styles.generateButtonText, { color: theme.onPrimary }]}>
                    {isGenerating ? 'Generando...' : 'Informe Estructurado por IA (v2)'}
                  </Text>
                </TouchableOpacity>
