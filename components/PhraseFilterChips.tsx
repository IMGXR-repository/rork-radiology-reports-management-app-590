...
interface PhraseFilterChipsProps {
  selectedFilters: string[];
  onFilterToggle: (filterId: string, categoryId: string) => void;
}

export function PhraseFilterChips({ selectedFilters, onFilterToggle }: PhraseFilterChipsProps) {
  const { phraseFilters, phraseCategories, settings } = useApp();
